...
enum
{
   ...
   ECT_REG_WD_TIMEPDI  = 0x0410,
   ECT_REG_WD_TIMESM   = 0x0420,
...
typedef enum
{
   ...
   EC_ERR_TYPE_FOE_ACCESS_DENIED		= 11,
   EC_ERR_TYPE_FOE_DISKFULL				= 12,
   ECAT_FOE_ERRCODE_ILLEGAL				= 13,
   ECAT_FOE_ERRCODE_PACKENO				= 14,
   ECAT_FOE_ERRCODE_EXISTS				= 15,
   ECAT_FOE_ERRCODE_NOUSER				= 16,
   ECAT_FOE_ERRCODE_BOOTSTRAPONLY		= 17,
   ECAT_FOE_ERRCODE_NOTINBOOTSTRAP		= 18,
   ECAT_FOE_ERRCODE_NORIGHTS			= 19,
   ECAT_FOE_ERRCODE_PROGERROR			= 20,
   ECAT_FOE_ERRCODE_INVALID_CHECKSUM	= 21,
   ECAT_FOE_ERRCODE_INVALID_FIRMWARE	= 22,
} ec_err_type;
